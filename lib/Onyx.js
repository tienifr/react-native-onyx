...
function update(data) {
    ...
    const index = pendingPromiseCount++;
    pendingUpdatePromise[index] = Promise.all(promises).then(() => {
        pendingUpdatePromise[index] = undefined;
    });
    return pendingUpdatePromise[index];
}
